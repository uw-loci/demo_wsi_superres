...
class ResNetFeatureExtractor(nn.Module):
    def __init__(self, weights_path=None, normalization='batch'):
        ...
        if weights_path is None:
            ...
            if normalization=='batch':
                ...
                resnet18_model = resnet18(pretrained=False, norm_layer=nn.InstanceNorm2d)
            resnet18_model.load_state_dict(torch.load(weights_path), strict=False)
        resnet18_model.fc = nn.Identity()
        resnet18_model.eval()
        self.model = resnet18_model
